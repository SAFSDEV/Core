...
"%JRE%" -Dsafs.project.config="%SAFSDIR%\project\JSAFSExample.ini" -Dmain_map="NLSBridgeTest.MAP" -Dlocalized="NLSBridgeTest_en.MAP" org.safs.tools.drivers.JSAFSDriver
