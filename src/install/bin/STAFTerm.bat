...
cscript "%SAFSDIR%\bin\ProcessKiller.vbs" -process java.exe -command com.ibm.staf.service.STAFServiceHelper -noprompt

cscript "%SAFSDIR%\bin\ProcessKiller.vbs" -process cmd.exe -command com.ibm.staf.service.STAFServiceHelper -noprompt

cscript "%SAFSDIR%\bin\ProcessKiller.vbs" -process STAFProc.exe -command STAFProc.exe -noprompt
