 ...
 * @since
 * <br>     JUL 15, 2005 (CANAGL) Added JavaClass support
 * <br>     APR 17, 2009 (CANAGL) Fixed problem in makeUniqueCacheKey
 * <br>     APR 23, 2009 (CANAGL) Added support for fullpath search mode(:FPSM:).
 * <br>     MAY 01, 2009 (CANAGL) Changes to complete FULLPATH_SEARCH_MODE implementation. 
 * <br>     MAY 11, 2009 (CANAGL) Support JPopups as child Panels in JFrames. 
 * <br>     JUL 20, 2009 (CANAGL) Added Domain= Category support.
 ...
 * <br>     DEC 09, 2009 (CANAGL) Fixed case-sensitive comparison error in isSeekingPopupMenu. Added "PopupMenu" support in isTopLevelPopupWindowType().
 * <br>     APR 23, 2010 (CANAGL) Mode convertToKeys handling case of individual null items in arrays.
...
public abstract class GuiObjectVector {
	 ...
	 * initGuiObjectRecognition();</ul>
	 * 
	 * @author canagl Oct 02, 2007 Added support for \; and .\;
	 */	
	...
	private boolean isTopLevelPopupWindowType(String objecttype){
		...
		//CANAGL 2009.12.09 I believe a PopupMenu should also be considered a TopLevelPopupWindow
...
//               		      soughttype.equalsIgnoreCase(WIN_POPUPMENU));
	...
	public Object getMatchingChildObject(Object _aparent, List gather) {
        ...
        Object result = null;
        GuiChildIterator.resetAbsoluteIndexStore(); //CANAGL 10-4-2007
        ...
        // (CANAGL) some depths are still only 1
        else{
			Log.info("GOV:getMatchingChildObject maxdepth=1:"+childName+" for "+ windowName);				
			
			// CANAGL Oct 03, 2007 DEBUG -- may no longer be necessary
