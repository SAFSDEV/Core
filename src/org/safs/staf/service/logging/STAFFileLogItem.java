 ...
 * name.
 * @author CANAGL 02/24/05 changed use of machine to effectiveMachine to avoid "localhost" 
 *          when finding STAF logs to export to SAFS logs.
 * @author CANAGL 11/03/2006 modified to process mixed-mode UTF-8 strings. 
 * 
...
public abstract class STAFFileLogItem extends FileLogItem
{
	 ...
	 * @author CANAGL 02/24/05 changed use of machine to effectiveMachine to avoid "localhost" when 
