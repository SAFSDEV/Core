...
public class STAFXmlLogItem3 extends AbstractSTAFXmlLogItem {
	...
	/**
	 * Creates a disabled <code>STAFXmlLogItem3</code> with default log level 
	 ...
	 */
	public STAFXmlLogItem3(String name, String parent, String file) {
		super(name, parent, file);
	}

	/**
	 * Creates a disabled <code>STAFXmlLogItem3</code> with default name (file
	 ...
	 * @param file		the file spec of this log.
	 */
	public STAFXmlLogItem3(String parent, String file) {
		super(parent, file);
	}
	 ...
	 * @param file		the file spec of this log.
	 */
	public STAFXmlLogItem3(String file) {
		super(file);
	}
