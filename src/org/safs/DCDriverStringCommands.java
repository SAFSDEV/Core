 ...
 *   <br>   Jan 13, 2004    (Carl Nagle) Fixed findSubstring to accept caret in varname strings.<br>
 ...
 *   <br>   APR 14, 2005    (Carl Nagle) GetSystemEnviron fixed to return SCRIPT_NOT_EXECUTED if unfulfilled.<br>
...
public class DCDriverStringCommands extends DriverCommand {
   ...
   * @author (Carl Nagle) Jan 13, 2004 Fixed to ignore leading caret on varname parameter.
   **/
  ...
  private void getMultiDelimitedField() throws SAFSException {
	 ...
	 * <p>
	 * (Carl Nagle) APR 14, 2005 return SCRIPT_NOT_EXECUTED if unable to satisfy.
	 * (Carl Nagle) MAY 02, 2005 use STAF/Env in STAF VAR service to read Environment variables.
	**/
