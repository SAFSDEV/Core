 ...
 *   <br>   SEP 09, 2004    (Carl Nagle)  Added/Fixed all partial text matching!
 *   <br>   AUG 18, 2005    (Jeremy_J_Smith) Added "Right Click" action
 *   <br>   Aug 22, 2005    (Bob Lawler)  Added SelectAnother*TextNode actions (RJL).
 ...
 *   <br>   Aug 26, 2005    (Bob Lawler)  Added captureTreeDataToFile() (with partial match) (RJL).
 *   <br>   Sep 02, 2005    (Bob Lawler)  Re-factored for CFTree to utilize 2DArray of tree (rather
 *   <br>                              than a Tree object) (RJL).
 *   <br>	Sep 08, 2005    (Bob Lawler)  Updated commandWithOneParam() and captureTreeDataToFile() 
 ...
 *   <br>   OCT 13, 2005    (Carl Nagle)  Changes to (hopefully) better support SWT
 *   <br>   OCT 18, 2005    (Carl Nagle)  Changed generic Click commands to ClickTextNode commands
 *   <br>   JAN 11, 2006    (Bob Lawler)  Updated captureTreeDataToFile() to format output file with 
 *   <br>                                  new optional parameter indentMark (default is tab \t). (RJL)
 *   <br>   JAN 19, 2006    (Bob Lawler)  Added verifyTreeContains() for new Component Functions: (RJL)
 ...
 *  													with our test path.
 *  <br>    OCT 28, 2008    (Carl Nagle)    Catch and process NullPointerException in to2DArray for empty trees.
 **/
public class CFTree extends CFComponent {
   ...
   * <br>    Sep 08, 2005    (Bob Lawler)  Improved messaging. RJL
   * <br>    OCT 13, 2005    (Carl Nagle)  Changes to (hopefully) better support SWT
   **/
   ...
   * @return                    String text of (first) root node. May be empty or null.
   * @author Bob Lawler 08.22.2005  -Added (RJL)
   *         Bob Lawler 08.26.2005  -Updated conditional if userObj == "" (empty string)
   *         Carl Nagle 09.27.2005  -Accomodate SWT Trees                 
   **/
   ...
   *  
   * @author Bob Lawler 09.08.2005  -Added (RJL)
   *                 
   **/
   ...
   * @author Bob Lawler				- Added 08.26.2005 (RJL)
   **/
   ...
   * @exception                 SAFSException
   * @author Bob Lawler				-Added 08.26.2005 (RJL)
   *  <br>	08.26.2005 (Bob Lawler) -Updated to trim off hidden root node before logging success
   *  <br>                       and improved success message. (RJL)
   *  <br>  10.13.2005 (Carl Nagle) -Changes to (hopefully) better support SWT
   *  <br>  01.11.2006 (Bob Lawler) -Updated to format output file with new optional parameter 
   ...
   * <br>
   * @exception                 SAFSException
   * @author Bob Lawler				-Added 01.19.2006 (RJL)
   * <br>	
   **/
