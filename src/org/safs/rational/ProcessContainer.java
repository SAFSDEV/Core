 ...
 *   <br>   SEP 02, 2004    (CANAGL) Do not seek children in comboboxes
 *   <br>   SEP 20, 2005    (CANAGL) Many enhancements for Functional Tester and object recognition in general.
 * 
 * @see org.safs.PCTree
 **/
...
//      PCTree tree = processContainer(container, 1, null, null);
   ...
   * 
   * @author Bob Lawler (bolawl), 08.29.2006 - Now that RGuiObjectRecognition.getName() has been 
