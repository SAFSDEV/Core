 ...
 *         Updated documentation.
 * @author Bob Lawler (bolawl), AUG 29, 2006
 ...
 * @author CANAGL, AUG 11, 2008 Added Firefox support for Caption
 ...
 * <br>		APR 16, 2010	(CANAGL)    Use Java Reflection to fix RFT API change in 8.1.1. 
 ...
 * <br>		NOV 24, 2010	(CANAGL)    Fixed use of getObjectClassName for FLEX domain.
...
public class RGuiObjectRecognition extends GuiObjectRecognition {
	 ...
	 * @author CANAGL  Apr 16, 2010 Use Java Reflection to fix RFT API change in 8.1.1.
	 **/
...
//									if (!(pid==processid)) continue;// not the right for the same browserclass
	...
	/**
	 * @author Bob Lawler (bolawl), 08.29.2006 - Added so that an Object can be recognized by its
  ...
  public static String getCaption(TestObject obj){
	...
	/**
	 * 
	 * 08.29.2006 - bolawl - With the addition of getObjectAccessibleName(), it's no longer necessary
	 ...
	 *
	 * MARCH 06, 2009 (CANAGL) Fixing NullPointerExceptions
	 * 
	 **/
