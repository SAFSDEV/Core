...
/** 
 * @author CANAGL OCT 26, 2005 Catch unexpected Rational Exceptions in getParentObjects
 * @author CANAGL OCT 28, 2005 Catch another unexpected Rational Exceptions in getParentObjects
 * @author CANAGL JAN 30, 2006 Domain disabling added.
 * @author BOLAWL AUG 29, 2006 Updated getParentObjects() to also check through the Owned objects
 ...
 * CANAGL  Jun 04, 2009     Updates with DynamicEnabler and JNA to catch some RFT hangs. 
 * CANAGL  Aug 07, 2009     Updates with DynamicEnabler to enable only a specific process with Process=. 
 ...
 * SBJLWA  AUG 13, 2013     Modify method getParentsByDomainName() and addTopWindowsFromDomainToWindowList() to catch UserStoppedScriptError. 
 **/
public class RGuiObjectVector extends GuiObjectVector {
	 ...
	 * @author CANAGL OCT 26, 2005 Catch unexpected Rational Exceptions
	 * @author CANAGL OCT 28, 2005 Catch another unexpected Rational Exception
	 * @author CANAGL JAN 30, 2006 Only return from Domains we have enabled.
	 * @author BOLAWL AUG 29, 2006 Updated to also check through the Owned objects
	 *                             of each Top Object found.
	...
	public TestObject getTopTestObject (DomainTestObject domain){
		...
		this.domain = domain; // CANAGL: this may no longer be needed?
		try{
			if(getProcessMode()==MODE_EXTERNAL_PROCESSING){
