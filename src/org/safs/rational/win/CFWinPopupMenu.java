...
/**
 * <br><em>Purpose:</em> 	CFWinPopupMenu, process a WIN PopupMenu component
 * @author  Lei Wang
 * @since   JUL 30, 2008
 *   <br>	JUL 30, 2008	(Lei Wang)	Original Release
 **/
public class CFWinPopupMenu extends CFWinMenuBar {
	public static final String SELECTINDEX                     = "SelectIndex";
	
	public CFWinPopupMenu(){
		super();
	}
