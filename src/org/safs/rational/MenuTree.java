 ...
 * @since   APR 25, 2008
 * 
 * <br>		JUN	12, 2009	(LeiWang)	Add method toString() to print the tree.
 * <br>		NOV 02, 2009	(LeiWang)	Modify method getTreePathAndStatus(String) to getTreePaths(String, boolean)
