...
public class DCDriverTimerCommands extends DriverCommand{
    ...
    **/
     ...
     *
     *@author Matt Casebeer
     *@param actionType int, Which type of action the Verify: 1 greater, 2 less, 3 range.
     *
     *@throws SAFSException
     */
     ...
     *@author Matt Casebeer
     *@param uid String unique name of the timer.
     ...
     *on timer id.
     *@param uid String unique timer id.
     ...
     *timers life cycle.
     *@param uid String String unique timer id.
     *@param verifyValue String value to use for verification.
     *
     *@throws SAFSException
     */
     ...
     *@param expected int Number of params expected.
     ...
     *@param file File   file to write information to
     *@param sLine String line of data to write.
     *@param append boolean to append data
     *
     */
