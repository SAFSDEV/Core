 ...
 * 
 * @author OCT 31, 2005 CANAGL Enhanced to allow a single class to be mapped to multiple 
 *                              object types via comma-separated list.
 * @author JUN 15, 2009 CANAGL Enhanced to allow final attempt at "Custom" files. 
 * @author JUN 18, 2009 CANAGL Reduce Logging to avoid queue full exceptions. 
 * @author FEB 07, 2013 SBJLWA Use IndependantLog instead of Log to log message.
 * @author AUG 13, 2013 CANAGL getMappedClassType supporting new 'recursive' and 'allowGeneric' options.
 **/
public class GuiClassData {
	 ...
	 * @author OCT 31, 2005 CANAGL Enhanced to allow a single class to be mapped to multiple 
	 *                              object types via comma-separated list.
	 * @author AUG 14, 2013 CANAGL Refactored to support recursive and allowGeneric options. 
	 */
	 ...
	 * 
	 * @author CANAGL OCT 31, 2005 modified to accept comma-separated classtype
	 **/
