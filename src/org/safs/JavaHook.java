 ...
 *   <br>   NOV 11, 2003    (CANAGL) Fixed bug: give TestRecordHelper the STAFHelper it needs.
 *   <br>   DEC 08, 2004    (CANAGL) Added support for evaluateRuntimeExceptions
 *   <br>   JAN 21, 2005    (CANAGL) Added support for semaphoreRoot and disabling System.exit.
 *   <br>   AUG 01, 2007    (CANAGL) Added support for hook_shutdown() for subclasses to add 
 *                                   shutdown activities.
 ...
 *   <br>	APR 26, 2016	(SBJLWA) Provide the ability to get configuration settings for Hook. 
 */
package org.safs;
