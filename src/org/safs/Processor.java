 ...
 * NOV 10, 2003    (Carl Nagle) Added constants for known record types.
 *                          Added new abstract isSupportedRecordType()
 * NOV 13, 2003    (Carl Nagle) Added support for stored processors or
 ...
 * NOV 19, 2003    (Carl Nagle) Additional refactoring.
 ...
 * JAN 29, 2007    (Carl Nagle) Added chainedProcessor support for all Processors.
 * JAN 25, 2008    (Carl Nagle) Removed Java 1.5 String.contains dependencies.
 * JUL 31, 2008    (Carl Nagle) Added CASEINSENSITIVE static strings for subclasses.
 * AUG 25, 2008    (Carl Nagle) Added try/catch in distributeConfigInfo routine.
 * MAR 26, 2009    (Carl Nagle) Added safsparams support for clearProxiesAlways.
 * MAR 08, 2011    (DharmeshPatel) Added RFSMOnly support for RFSM search mode.
 * JUL 22, 2013    (Lei Wang) Added methods deducexxxFile().
 * DEC 01, 2016    (Lei Wang) Added methods setAtEndOfProcess() etc.
 **/
package org.safs;
