 ...
 * <p>
 * Refer to <a href="/sqabasic2000/JSAFSFrameworkContent.htm#configfile"
...
public class ProjectInstaller {
	...
	protected void processINIFile(File inifile){
        ...
        // **********************
        tempvalue = reader.getAppMapItem(DriverConstant.SECTION_SAFS_DIRECTORIES, SafsDirectories.ITEM_DATADIR); // root dir
        if(tempvalue != null){
        ...
        tempvalue = reader.getAppMapItem(DriverConstant.SECTION_SAFS_DIRECTORIES, SafsDirectories.ITEM_BENCHDIR);
        if(tempvalue != null){
        ...
        tempvalue = reader.getAppMapItem(DriverConstant.SECTION_SAFS_DIRECTORIES, SafsDirectories.ITEM_TESTDIR);
        if(tempvalue != null){
        ...
        tempvalue = reader.getAppMapItem(DriverConstant.SECTION_SAFS_DIRECTORIES, SafsDirectories.ITEM_DIFFDIR);
        if(tempvalue != null){
        ...
        tempvalue = reader.getAppMapItem(DriverConstant.SECTION_SAFS_DIRECTORIES, SafsDirectories.ITEM_LOGDIR);
        if(tempvalue != null){
