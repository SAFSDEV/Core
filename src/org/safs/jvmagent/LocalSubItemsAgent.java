 ...
 * some qualifying factor like index or text.  This interface represents the server-side 
 * of the implementation and is intended to match the remote SubItemsAgent interface.
 * 
 * @author canagl
 * @since Apr 7, 2005
 * @see org.safs.rmi.engine.SubItemsAgent
 */
