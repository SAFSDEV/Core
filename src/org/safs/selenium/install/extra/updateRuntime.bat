...
SET SE_LIB_UPDATE=http://***REMOVED***:81/jenkins/job/SeleniumPlus/ws/updatesite/lib/latest/SEPLUS.LIB.UPDATE.ZIP
SET SE_PLUGIN_UPDATE=http://***REMOVED***:81/jenkins/job/SeleniumPlus/ws/updatesite/plugin/latest/SEPLUS.PLUGIN.UPDATE.ZIP
SET SAFS_LIB_UPDATE=http://***REMOVED***:81/jenkins/job/SAFS/ws/updatesite/lib/latest/SAFS.LIB.UPDATE.ZIP
