...
SET SE_LIB_UPDATE=%GITHUB_UPDATE%/seleniumplus/SEPLUS.LIB.UPDATE.ZIP
SET SE_PLUGIN_UPDATE=%GITHUB_UPDATE%/seleniumplus/SEPLUS.PLUGIN.UPDATE.ZIP
SET SE_SOURCE_UPDATE=%GITHUB_UPDATE%/seleniumplus/source_all.zip
SET SAFS_LIB_UPDATE=%GITHUB_UPDATE%/safs/SAFS.LIB.UPDATE.ZIP
SET SAFS_SOURCE_UPDATE=%GITHUB_UPDATE%/safs/source_all.zip
