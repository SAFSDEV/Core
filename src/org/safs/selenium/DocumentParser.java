 ...
 *  
 * @author Junwu Ma	Feb 18, 2011	Initial creation.
 * @author Lei Wang   Mar 18, 2011    Implement methods to manipulate dom4j's document, node, element, attribute etc.<br>
 ...
 * @author Lei Wang   Jun 07, 2011    Modify methods generateAttributRS(), getAttribute() and getIndex().<br>
 * @author Lei Wang   Jun 28, 2011    Add method getAttributes().<br>
 * @author Lei Wang   Aug 10, 2012    Rename getRobotRecognition() to getRobotRecognitionNode(): return a SPCTreeNode
...
//		setDocument(selenium.getLocation(), null, true);
	...
	public void setHTTPProxy() {
		//TODO read this settings from configuration file
...
//			}
	 ...
	 * @return
	 * AUG 10, 2012		(Lei Wang) Use SPCTreeNode to contain "recognition string", element's id and element's name.
