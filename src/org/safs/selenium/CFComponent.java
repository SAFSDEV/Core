 ...
 *   <br>   JAN 16, 2007    (CANAGL) Removed Java 1.5 dependency.
 *   <br>   AUG 01, 2007    (CANAGL) Made search for SAFSKeycodeMap.dat use the whole System CLASSPATH.
 *   <br>   FEB 01, 2010    (CANAGL) expanded casting of SeleniumGUIUtilities where needed.
 *   <br>   JUN 21, 2011    (LeiWang) Add two propeties winObject and compObject of type SGuiObject.
 ...
 *   <br>   JUN 28, 2011    (LeiWang) Update 12 keywords.
 *   <br>   JUL 04, 2011    (LeiWang) Update keywords: maximize, minimize, restore, add keyword shiftclick.
 *   <br>   MAR 05, 2014    (SBJLWA) Move some keywrod constants to ComponentFunction.
 *   
 * @see java.awt.Robot
