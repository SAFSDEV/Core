 ...
 * SEP 26, 2017     (Lei Wang) Added fields 'cssDisplay' and 'cssVisibility'.
 * DEC 06, 2018     (Lei Wang) Added fields 'parentFrameRS'.
 */
...
public class SPCTreeNode extends DefaultMutableTreeNode{
	...
	/**
	 * it contains the value of web-element's css property 'display'.
	 */
	private String cssDisplay = null;

	/**
	 *  it contains the value of web-element's css property 'visibility'.
	 */
	private String cssVisibility = null;

	/**
	 * It contains the value of the accessibility of an element on page.<br>
	 * It can be a simple object containing accessible properties; or it can be a collection of objects containing accessible properties.<br>
	 */
	private Object accessibilities = null;

	/**
	 * Contains the recognition string of the frame to which this node belongs.
	 * It can be null if this node is in the top most document (no frame).<br>
	 *
	 * It will be assigned in method {@link SPCTreePanel#addSPCTreeNode(org.openqa.selenium.WebElement, String, SPCTreeNode)}<br>
	 * It will be set to {@link WDSPCGUI#jcb_frames} when clicking on this node.<br>
	 *
	 */
	private String parentFrameRS = null;
...
//		this.xpart = xpath.substring(xpath.lastIndexOf("/")+1);
	...
	public void setCssDisplay(String cssDisplay) {
		this.cssDisplay = cssDisplay;
	}

	public String getCssVisibility() {
		return cssVisibility;
	}

	public void setCssVisibility(String cssVisibility) {
		this.cssVisibility = cssVisibility;
	}
	...
	public String getParentFrameRS() {
		return parentFrameRS;
	}

	public void setParentFrameRS(String parentFrameRS) {
		this.parentFrameRS = parentFrameRS;
	}

	public Object getAccessibilities() {
		return accessibilities;
	}

	public void setAccessibilities(Object accessibilities) {
