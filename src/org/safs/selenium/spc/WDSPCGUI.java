...
public class WDSPCGUI extends JPanel implements ActionListener,MouseListener,WindowListener,TreeSelectionListener{
	 ...
	 * @param data
	 * @param xpaths
	 * @author CANAGL JAN 27, 2015 Added Frames support.
	 */
	...
	/**
	 *  AUG 10, 2012	(SBJLWA) During getting the Recognition String according to a node's xpath,
