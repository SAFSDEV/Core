 ...
 *
 * <pre>
 *  Apr 25, 2014    (sbjlwa) Initial release.
 *  May 05, 2014    (sbjlwa) Modify methods selectItem and verifyItemSelection to accept one more parameter 'matchIndex'.
 *  May 05, 2014    (sbjlwa) Modify methods selectItem to accept one more parameter 'key'.
 *  May 29, 2014    (sbjlwa) Modify methods selectItem to accept more parameter 'offset' and 'mouseButtonNumber'.
