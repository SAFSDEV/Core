 ...
 *  May 29, 2014    (sbjlwa) Use single-click for selectItem, double-click for activateItem.
 *  Oct 15, 2014    (sbjlwa) Modify showOnPage(): move the code 'test visiblility' to super class.
 *  Nov 05, 2014    (sbjlwa) Add waitAndVerifyItemSelected(): used to verify item selection.
 *  </pre>
 */
