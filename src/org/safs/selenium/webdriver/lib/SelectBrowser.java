...
*  <br>   NOV 18, 2013    (Carl Nagle) Modified to allow us to change capabilities in one place for any kind of webdriver instantiated.
*  <br>   DEC 27, 2013    (Lei Wang) Modify code to permit start browser with more parameters, such as proxy setting.
*  <br>   JAN 28, 2014    (Lei Wang) Modify code to get proxy setting from system properties.
