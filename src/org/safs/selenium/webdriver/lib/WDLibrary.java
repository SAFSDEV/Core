...
*  <br>   FEB 26, 2016    (SBJLWA) Modify click(), doubleClick(): if the offset is out of element's boundary, disable the click listener.
...
*  <br>   MAY 22, 2017    (SBJLWA) Modified startBrowser(): use isValidBrowserID() instead of StringUtils.isValid() to check the validity of parameter browser ID.
*  <br>   JUN 06, 2017    (SBJLWA) Modified focus(): catch exception separately so that each way will be tried to set focus.
*
*/
