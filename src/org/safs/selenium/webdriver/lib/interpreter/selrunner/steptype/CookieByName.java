 ...
 *
 */
public class CookieByName extends com.sebuilder.interpreter.steptype.CookieByName implements SRunnerType{
	@Override
	public void processParams(Step step, String[] params) {
		//param[1] is the cookie's name
		step.stringParams.put(Constants.PARAM_NAME, params[1]);
		//param[2] is the 'variable' for Store, 'value' for Verify
