 ...
 * @author Lei Wang
 *
 * This a getter class for get element's attribute, its parameters are:<br>
 * <b>parameter[0]</b> the command itself, such as storeElementAttribute, verifyElementAttribute etc.<br>
 * <b>parameter[1]</b> the element locator.<br>
 * <b>parameter[2]</b> the element's attribute name.<br>
 ...
 */
public class ElementAttribute extends com.sebuilder.interpreter.steptype.ElementAttribute implements SRunnerType{
	@Override
	public void processParams(Step step, String[] params) {
		SRUtilities.setLocatorParam(step, params[1]);
		step.stringParams.put(Constants.PARAM_ATTRIBUTE_NAME, params[2]);
