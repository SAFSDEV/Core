 ...
 * History:
 *
 *  JAN 29, 2014    (sbjlwa) Initial release.
 *  FEB 12, 2014    (sbjlwa) Modify method SapCheckable_CheckBox.setChecked() to refresh the stale embedded webelement.
 *  JUN 12, 2015    (sbjlwa) Click to check/uncheck firstly, native-javascript will be a backup.
