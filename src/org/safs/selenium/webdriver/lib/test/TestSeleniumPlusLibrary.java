...
public class TestSeleniumPlusLibrary {
	...
	static String startFireFoxBroswer(String url) throws SeleniumPlusException{
		...
		extraParameters.put(SelectBrowser.KEY_PROXY_BYPASS_ADDRESS, "localhost,127.0.0.1,internal.server,internal.server,internal.server");
	...
	static void testSapCheckBox() throws SeleniumPlusException{
		String id = startFireFoxBroswer("http://internal.server/openui5home/1.16.8/checkbox.htm");
	...
	static void testNormalComboBox() throws SeleniumPlusException{
		String id = startFireFoxBroswer("http://internal.server.apac.sas.com/TestDojo/demo/combobox.php");
	...
	static void testDojoSelect() throws SeleniumPlusException{
		String id = startFireFoxBroswer("http://internal.server/dojohome/demo/Select.php");
	...
	static void testDojoComboBox() throws SeleniumPlusException{
		String id = startFireFoxBroswer("http://internal.server/dojohome/demo/ComboBox.php");
	...
	static void testDojoFilteringSelect() throws SeleniumPlusException{
		String id = startFireFoxBroswer("http://internal.server/dojohome/demo/FilteringSelect.php");
		WebElement combo = WDLibrary.getObject("id=widget_stateSelect");
	...
	static void testSapComboBox() throws SeleniumPlusException{
		String id = startFireFoxBroswer("http://internal.server/openui5home/1.16.8/combobox.htm");
	...
	static void testJavaScriptOnDOJOApplication() throws SeleniumPlusException{
		String id = startFireFoxBroswer("http://internal.server/TestDojo/demo/combobox.php");
