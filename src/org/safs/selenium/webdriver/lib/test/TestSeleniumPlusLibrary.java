...
public class TestSeleniumPlusLibrary {
	...
	static String startFireFoxBroswer(String url) throws SeleniumPlusException{
		...
		//User needs to set the internet proxy server to connect the internet
		extraParameters.put(SelectBrowser.KEY_PROXY_SETTING, "internet.proxy.server:80");
		extraParameters.put(SelectBrowser.KEY_PROXY_BYPASS_ADDRESS, "localhost,127.0.0.1,tadsrv");
