 ...
 *  SEP 02, 2014    (Lei Wang) Update to support sap.m.Select, sap.m.ComboBox
 ...
 *  MAY 19, 2017    (Lei Wang) Modified HtmlSelect.getOptions(): use OptionForHtmlSelect instead of Option.
 *                           Modified AbstractSelect.getOptions() and HtmlSelect.getOptions(): pause a while before getting options.
 *  MAY 22, 2017    (Lei Wang) Modified ComboBox.select(): For unverified-selection, don't get the selected options from combo-box after selection,
