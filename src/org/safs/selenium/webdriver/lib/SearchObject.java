 ...
 *  <br>  MAY 06, 2016    (SBJLWA)  Modified js_executeWithTimeout(): throw SeleniumPlusException if the timeout is not enough for javascript execution.
...
//				return null;
	...
	public static WebElement getObject(SearchContext sc, String recognitionString){
		...
		//3. SBJLWA, FIX http://internal.server/cgi-bin/quick_browse?defectid=S1138290
...
//			Object object = getJS().executeScript(JavaScriptFunctions.getJSErrorObject());
	...
	public static boolean isStale(WebElement element) throws SeleniumPlusException{
		...
		try{ t.join(600);}
			...
			__isStaleException = x; //CANAGL -- Evaluate if we want this Exception thrown below
		}
	 ...
	 *
	 * History:<br>
	 *  <br>   Apr 14, 2014    (sbjlwa) Initial release.
	 *
	 ...
	 *
	 * History:<br>
	 *  <br>   Apr 15, 2014    (sbjlwa) Initial release.
	 *
	 * @see SearchObject#addJavaScriptEventListener(WebElement, String, GenericJSEventListener)
	 */
	...
	public static Object executeScript(boolean synch, String script, Object... args) throws SeleniumPlusException{
		...
		try{
			...
			// CANAGL: this is getting caught AFTER the attempt to return object; above is initiated!?
	...
	static boolean checkCSSClassName(WebElement element, String prefix, String separator){
		...
		try{
			...
			if(clazz!=null){
				...
				// (CANAGL)if isSatisfied=true then we don't have to check any further, right?!!
				if(!isSatisfied){
