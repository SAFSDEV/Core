 ...
 * APR 08, 2015    (SBJLWA) Modify method setSystemProperties(): Call StringUtils.getSystemProperty to handle configuration values
 *                          and set them to system properties.
 * APR 25, 2016    (SBJLWA) Modify start() etc.: Profit the configuration settings ability in JavaHook.
 */
 ...
 * <p>
 * 
 *   <br>   JAN 16, 2007    (CANAGL) Initial Release.
...
public class SeleniumHook extends JavaHook {
	...
	public static final String SAFS_USER_EXTENSIONS = "org/safs/selenium/webdriver/user-extensions.js";
