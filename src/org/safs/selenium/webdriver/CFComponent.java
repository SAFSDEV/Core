 ...
 * History:<br>
 *
 *   <br>   NOV 19, 2013    (CANAGL) Original Release.
 *   <br>   DEC 18, 2013    (LeiWang) Update to support ComboBox.
 *   <br>   MAR 05, 2014    (SBJLWA) Move some keywrod constants to ComponentFunction, implement click-related keywords.
 *   <br>   APR 29, 2014    (SBJLWA) Support keyword ExecuteScript.
 ...
 *   <br>   OCT 30, 2015    (SBJLWA) Modify exist(): highlight component for keyword GUIDESOEXIST etc.
 *   <br>   NOV 26, 2015    (SBJLWA) Remove checkForCoord() and _lookupAppMapCoordReference(), their functionality will be provided by super class.
