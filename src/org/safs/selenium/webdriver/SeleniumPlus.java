...
public abstract class SeleniumPlus {
	 ...
	 * @see EmbeddedHookDriverRunner#autorun(String[])
	 */
	private static boolean _autorun = false;
	/**
	...
	public static boolean StartWebBrowser(String URL,String BrowserID, String... params){
		try{
			String[] allParams = combineParams(params, URL, 
					                                   BrowserID);
	 ...
	 */
	private static String[] _resolveDDVariables(String parameter, String... optionals) throws SeleniumPlusException{
	...
	public static final class Component{
		 ...
		 * String value = SeleniumPlus.GetVariableValue("signinText");
		 ...
		 * See <a href="http://safsdev.sourceforge.net/sqabasic2000/GenericMasterFunctionsReference.htm#detail_GUIDoesExist">Detailed Reference</a>
		 * <p>
		 ...
		 * See <a href="http://safsdev.sourceforge.net/sqabasic2000/GenericMasterFunctionsReference.htm#detail_GUIDoesNotExist">Detailed Reference</a>
		 * <p>
		 * @param comp -- Component (from App Map).  
		 ...
		 * See <a href="http://safsdev.sourceforge.net/sqabasic2000/GenericMasterFunctionsReference.htm#detail_HoverMouse">Detailed Reference</a>
		 ...
		 * String existence = SeleniumPlus.GetVariableValue(PropertyExistVariable);
		 * }
		 * </pre>
		 ...
		 * See <a href="http://safsdev.sourceforge.net/sqabasic2000/GenericMasterFunctionsReference.htm#detail_LocateScreenImage">Detailed Reference</a>
		 ...
		 * See <a href="http://safsdev.sourceforge.net/sqabasic2000/GenericMasterFunctionsReference.htm#detail_SaveTextFromGUI">Detailed Reference</a>
		 * <br>
		 * This requires that SAFS-OCR has been installed.
		 * @param comp Component (from App Map) from which to retrieve text.
	...
	public static boolean Highlight(boolean OnOff){
		String param = String.valueOf(OnOff);
		return command(DDDriverCommands.HIGHLIGHT_KEYWORD,param);		
	}
	...
	public static boolean SetVariableValue(String variableName, String variableValue){
		try{ 
			if(variableName == null) throw new SAFSException("SetVariableValue variableName cannot be null!");
			if(variableName.length()==0) throw new SAFSException("SetVariableValue variableName cannot be empty!");			
	 ...
	 *   String[] adjustedArgs = combineParams(args, SeleniumPlus.ARG_AUTORUN_CLASS, "your.auto.run.classname");
	 ...
	 */
	private static boolean testStatusCode(String command, TestRecordHelper testRecord){
		String debumsg = StringUtils.debugmsg(SeleniumPlus.class, "testStatusCode");
	 ...
	 */
	private static boolean actionGUILess(String command, String... params) throws SAFSRuntimeException{
	 ...
	 * @see org.safs.TestRecordHelper#getStatusInfo()
	 */
	private static boolean action(org.safs.model.Component component, String command, String... params) throws SAFSRuntimeException{
		try{
			...
			String debumsg = StringUtils.debugmsg(SeleniumPlus.class, "action", command+" failed with Exception ", t);
	 ...
	 * @see org.safs.TestRecordHelper#getStatusInfo()
	 */
	private static boolean command(String command, String... params) throws SAFSRuntimeException{
		try{
			...
			prevResults = null;
			String debumsg = StringUtils.debugmsg(SeleniumPlus.class, "command", command+" failed with Exception ", t);
			IndependantLog.error(debumsg);
			return false;
		}
	}
	 ...
	 */
	public static String[] combineParams(String[] extraParams, String... preParams){
	...
	/**
	 * Sometimes the parameter (like coordination) will contain separtor, but if this one is<br>
	 * the same as 'test-step-separtor', then that parameter will not be correctly parsed,<br>
	 * we need to replace it by a different one.<br>
	 * To replace the possible conflicted separator in parameters.<br> 
	 */
	private static String[] replaceSeparator(String... params){
	...
	public static final class Assert{
		...
		public static void setAbortOnFailure(boolean abortOnFailure){
			...
			Runner.debug("SeleniumPlus ASSERT 'Abort On Failure' has been turned "+ status);
	 ...
	 */
	public static final class TabControl{
	 ...
	 */
	public static final class WDTimeOut{
	...
	public static final class Misc{
		...
		*/
        ...
        false if the script reports failure or an error occured during execution.<p>
        * @see #prevResults
		* @see org.safs.TestRecordHelper#getStatusCode
		* @see org.safs.TestRecordHelper#getStatusInfo
		* <p>
		...
		*  
		*  //checkbox.json is in a Scripts subdirectory for the Project.
		...
		* String value = SeleniumPlus.GetVariableValue("var");
		...
		*/
		public static Point2D.Double CaptureMousePositionOnScreen(String variableX, String variableY) throws SeleniumPlusException{
			try{
				...
				if(x==null || x.isEmpty()) x = WDLibrary.generateUniqueName("x");
				if(y==null || y.isEmpty()) y = WDLibrary.generateUniqueName("y");
		...
		*/
		...
		/**
		 * Pause testcase flow in milliseconds. If you want to pause in seconds, use {@link Pause(int)}.
		...
		/**
		 * Pause testcase flow in seconds. If you want to pause in milliseconds, use {@link Delay(int)}.<br>
		 * It is the same as {@link SeleniumPlus#Pause(int)}.<br>
		 * @param seconds int, the seconds to pause
		 * @return true if successful, false otherwise.<p>
		 * @see #Delay(int)
		 */
		...
		/**
		 * Get the general pause time between records (SeleniumPlus API calls), in milliseconds.
		...
		/**
		 * Set the general pause time between records (SeleniumPlus API calls), in milliseconds.
		...
		/**
		 * Get the string value of the system datetime in the format MM-DD-YYYY HH:MM:SS
		 * @param military boolean, if true the hour string will be 24-hours format; otherwise is 12 AM/PM.
		 * @return String, the string value of the system datetime. null if execution fails.
		 * 
		 * @see #prevResults
		 * @see org.safs.TestRecordHelper#getStatusCode
		 * @see org.safs.TestRecordHelper#getStatusInfo
		...
		/**
		 * Set the value of a variable/DDVariable; for DDVariable, refer to {@link SeleniumPlus} Note3.<br>
		 * The different between this method and SeleniumPlus#SetVariableValue(String, String) is that this method<br>
		 ...
		 * @see org.safs.TestRecordHelper#getStatusCode
		 * @see org.safs.TestRecordHelper#getStatusInfo
		 * @see SeleniumPlus#SetVariableValue(String, String)
		 * <p>
		 * @example
		 * <pre>
		 * {@code
		...
		public static boolean SetVariableValueEx(String variable, String value){
			...
			try{ 
				if(variable == null) throw new SAFSException("parameter 'variable' cannot be null!");
		...
		/**
		 * Set the value of one or more DDVariables; for DDVariable, refer to {@link SeleniumPlus} Note3.<br>
		...
		public static boolean SetVariableValues(String varEqualVal, String...optionals){
			...
			try{ 
				if(varEqualVal == null) throw new SAFSException("parameter 'varEqualVal' cannot be null!");
		 ...
		 *      Relative file path, 
		 *        if it contains file separator, it is relative to datapool or project root.
		 *        otherwise it is relatvie to the project test folder.
		 * </pre>
		 * @return true if successful, false otherwise.<p>
		 * @see #prevResults
		 * @see org.safs.TestRecordHelper#getStatusCode
	...
	public static final class Files{
		 ...
		 * @param outputFile String, the name of file to sotre the found files name.
		 ...
		 * {@code
		 * String file = "C:\\Users\\Lei Wang\\TestDriverCommand\\New Directory\\new test file3.txt";
		 * String dest = "C:\\Users\\Lei Wang\\TestDriverCommand\\New Directory\\second copy of file3.txt";
		 ...
		 *     System.out.println("'"+content+"' has been written to file '"+fileNo+"' in same line immidiately.");
		 *   }
		 *   if(Files.PrintToFile(fileNo, separator)){
		 *     System.out.println("'"+separator+"' has been written to file '"+fileNo+"' in a new line.");
		 *   }
	...
	public static final class Strings{
		 ...
		 * @param fixedWidth int, the fixedwidth allotted for each field in the record 
		 * @param resultVar String, the variable to hold the result of the operation 
		 * @return boolean true if successful, false otherwise.<p>
		 * @example
		 * <pre>
		...
		/**
		 * Finds the count of all fields within the input string found from startindex to the end of the inputRecord.
		 ...
		 * @param source String, The input string to parse
		 * @param startIndex int, 0-based startindex to begin parsing the string. 
	...
	public static final class Counters{
		...
		<a href="http://safsdev.sourceforge.net/sqabasic2000/DDDriverCounterCommandsReference.htm#detail_StartCounter">Detailed Reference</a>
        ...
        */     
		...
		<a href="http://safsdev.sourceforge.net/sqabasic2000/DDDriverCounterCommandsReference.htm#detail_StopCounter">Detailed Reference</a>
        @param counterId -- the unique Id of the counter.
        @param details -- optional -- any additional (String) details or description of the counter to be logged. 
        @return true if successful, false otherwise.<p>
        * @see #prevResults
        ...
        */     
		...
		<a href="http://safsdev.sourceforge.net/sqabasic2000/DDDriverCounterCommandsReference.htm#detail_SuspendStatusCounts">Detailed Reference</a>
        ...
        */     
        ...
        will remain stopped.
		<a href="http://safsdev.sourceforge.net/sqabasic2000/DDDriverCounterCommandsReference.htm#detail_ResumeStatusCounts">Detailed Reference</a>
        ...
        */     
        ...
        <a href="http://safsdev.sourceforge.net/sqabasic2000/DDDriverCounterCommandsReference.htm#detail_LogCounterInfo">Detailed Reference</a>
        @param counterId -- the unique Id of the counter.
        @return true if successful, false otherwise.<p>
        * @see #prevResults
		* @see org.safs.TestRecordHelper#getStatusCode()
        ...
        */
        ...
        <a href="http://safsdev.sourceforge.net/sqabasic2000/DDDriverCounterCommandsReference.htm#detail_StoreCounterInfo">Detailed Reference</a>
        @param counterId -- the unique Id of the counter.
        @param varPrefix -- the unique root name for a list of DDVariables to hold the counter info.
        @return true if successfully executed, false otherwise.<p>
        @see SeleniumPlus#GetVariableValue(String)
        @see #prevResults
		@see org.safs.TestRecordHelper#getStatusCode()
		@see org.safs.TestRecordHelper#getStatusInfo()
		<p>        
		...
		try{ 
			try{
				...
				do{
					...
					System.out.println("SeleniumPlus test search evaluating "+ theClass);
					Class c = Class.forName(theClass);
					Class sc = c.getSuperclass();
					if(sc.getName().equals(SeleniumPlus.class.getName())){
			...
			if(!_isSPC) {
				...
				StartTestSuite(test.getClass().getSimpleName());
			}
			if(_autorun){
