 ...
 * <p>
 * Note: For consistent operation the property <b><code>java.rmi.server.hostname</code></b> needs to be set in code or
 ...
 *       please set property <b><code>server.port</code></b> in code or on the command line:
 * <p>
 * <ul><code>-Dserver.port=&lt;RMI server port&gt;</code></ul>
 * <ul><code>System.setProperty("server.port", "8900");</code></ul>
 * <p>
 * Note: Normally Java creates a registry Object object using a konwn port  {@link Registry#REGISTRY_PORT 1099}.
 *       If you want an other port for the registry, please set property <b><code>registry.port</code></b> in code
 *       or on the command line:
 * <p>
 * <ul><code>-Dregistry.port=&lt;Remote Registry port&gt;</code></ul>
 * <ul><code>System.setProperty("registry.port", "1100");</code></ul>
 *
...
public class SeleniumServer extends RemoteRoot implements SeleniumRMIServer{
	 ...
	 */
	public SeleniumServer(int serverPort) throws RemoteException{
		super(serverPort);
		rebindLocalRMIRegistry(serverName, this);
	}
	...
	public void init(){
		...
		//DO NOT try to set any field of this class SeleniumServer, they will be reinitialized after calling super() in the constructor.
		//We can set the field of super class
	...
	public static void main(String[] args){
		try{
//			System.setProperty(JAVA_RMI_SERVER_HOSTNAME_PROPERTY, "172.18.0.3");
//			System.setProperty(PROPERTY_REGISTRY_PORT, "1099");
//			System.setProperty(PROPERTY_SERVER_PORT, "8958");

			String serverPort = System.getProperty(PROPERTY_SERVER_PORT);
			if(serverPort!=null){
				new SeleniumServer(Integer.parseInt(serverPort));
			}else{
				new SeleniumServer();
			}
