...
public class GenericJDBC {
	...
	/** "sharenet://qashr05.unx.sas.com:5011" */
	public static final String DEFAULT_CONNECTION = "sharenet://qashr05.unx.sas.com:5011";
	...
	public void updateData( String connectURI,
	   ...
	   try {
	     ...
	     //conn = java.sql.DriverManager.getConnection("jdbc:sharenet://qashr05.unx.sas.com:5011",prop);
