...
/**
 * Developer Logs:
 * SEP 21, 2016		SBJLWA	Modified incrementXXXStatus(): check non-standard status code, such as DriverConstant.STATUS_XXX_LOGGED.
 * SEP 22, 2016		SBJLWA	Modified incrementGeneralStatus(): if status is like DriverConstant.STATUS_TESTXXX_LOGGED, increment "test" counter.
 */
