 ...
 *         bolawl 		Jan 18, 2006 	Updated cmdLogMessage to better handle empty descriptions (RJL)
 * 		   LeiWang		Apr 08, 2008	Add SuspendLogging and ResumeLogging
 * 		   CANAGL		FEB 04, 2010	Added missing SuspendLogging and ResumeLogging messages
...
public class TIDDriverLogCommands extends GenericEngine {
	 ...
	 * 
	 * updates:
	 * 01.18.2006 (bolawl) - better handle empty descriptions (RJL)
	 */
