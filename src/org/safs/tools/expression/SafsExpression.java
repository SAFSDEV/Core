 ...
 * OCT 04, 2004 CANAGL 	Added old-style substitute/extract variables processing for
 *                     	when EXPRESSIONS are not enabled.
 * OCT 27, 2004 CANAGL 	Fixed "0" conversion at end of evalPrimative.  Also the handling
...
public class SafsExpression {
	...
	protected String evalPrimative(String strLeftOperand, String strOperator, String strRightOperand) {
		...
		/* (CANAGL)if NOT a concatenation result:
