 ...
 * <br>		CANAGL	    APR 08, 2009	Added missing support for NameContains
 * <br>		CANAGL	    APR 17, 2009	Added HTMLText support for isFinalMatch
 * <br>		CANAGL	    JUL 20, 2009	Added Domain= Category support.
 * <br>		CANAGL	    JUL 28, 2009	Added public getDomainValue Getter.
 * <br>		CANAGL	    JUL 28, 2009	Added Process= Category support.
 * <br>		CANAGL	    Aug 07, 2009	Fixed some Domain and Process initialization calls.
 * <br>		CANAGL	    Oct 26, 2009	Enhanced isMatchingText to check for undesirable mnemonic '&' chars.
 * <br>		CANAGL	    FEB 02, 2010	Qualifier HTMLTitle=text allows for matching isMatchingCaption OR isMatchingText
 * <br>		CANAGL	    JUN 15, 2010	Allow NBSP to be replaced with SPACE in HTML domain comparisons.
 * 
 * Copyright (C) (SAS) All rights reserved.
...
public abstract class GuiObjectRecognition {
	 ...
	 * 2009.04.08 (CANAGL) Added missing support for NameContains
	 **/
	 ...
	 * 
	 * @author Bob Lawler (bolawl), 08.29.2006 - Updated to first try getObjectAccessibleName() 
     *         and, if necessary, try getObjectName() when saving the Object's name.  This preserves
     *         backwards compatability when retrieving Object name.
	 **/
...
//				if (parentClass.equals(soughtClass)){
	 ...
	 * 
	 * @author Bob Lawler (bolawl), 08.29.2006 - Updated to first call getObjectAccessibleName() 
	 ...
	 * @param theObject
	 * @return String
	 * @author Bob Lawler (bolawl), 08.29.2006
	 */
