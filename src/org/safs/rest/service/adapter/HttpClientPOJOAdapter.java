...
public abstract class HttpClientPOJOAdapter {
     ...
     */
    public abstract String getHTTPClientName();
    ...
    public void assertRequestSupported(final Map<String, Object> request) throws Exception {
        ...
        if (reason != null) {
            // TODO:  if this class is moved beside HttpClient, change this exception.
            throw new HttpServerTestingFrameworkException(reason);
        }
    }
