...
class ApiMetaDetailsVerifier {
    public static final RESOURCE_LIST_DEPRECATED_MESSAGE = '''
        ...
        |       with current SAS REST API standards (see http://myhost.sas.com/saspedia/Implementing_REST_APIs#API_metadata).
        |       resources property: {}
        '''.stripMargin('|')
     ...
     * The saspedia guide to implementing REST APIs lists the "standard" properties
     * <a href="http://myhost.sas.com/saspedia/Implementing_REST_APIs#apiMeta">here</a>.
     *
    ...
    void verifyStandardApiMetaProperties(Map apiMetaDetails, CharSequence serviceResource, int expectedResourcesMinimumSize) {
        ...
        // (http://myhost.sas.com/saspedia/Implementing_REST_APIs#API_metadata), the only property
    ...
    void verifyApiMetaResources(Map apiMetaDetails, CharSequence serviceResource, int expectedResourcesMinimumSize) {
        ...
        //
        // Eventually, some future JIRA story will address verifying the correct API metadata.
     ...
     * to /apiMeta. The saspedia guide to implementing REST APIs lists the build information properties
     * at the bottom of <a href="http://myhost.sas.com/saspedia/Implementing_REST_APIs#apiMeta">this section</a>.
     *
     * @param apiMetaDetails a Map containing the parsed details from the {@link Response}
     */
