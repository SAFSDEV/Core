 ...
 */
public class InstrumentsLaunchFailureException extends SAFSException {
	   ...
	   **/
	public InstrumentsLaunchFailureException(String msg) {
		super(msg);
	}
	   ...
	   * @param String msg, comment about the nature of the Exception
	   **/
	public InstrumentsLaunchFailureException(Object obj, String msg) {
		super(obj, msg);
	}
	   ...
	   * @param String msg, comment about the nature of the Exception
	   **/
	public InstrumentsLaunchFailureException(Object obj, String methodName,
			String msg) {
