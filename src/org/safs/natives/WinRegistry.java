...
public class WinRegistry {
   ...
   * @param key
   * @param valueName String, the value name; "" should be provided if value "(Default)" is wanted.
   ...
   * @param hkey
   * @param key
   * @param value String, the value name; "" should be provided if value "(Default)" is to delete.
   * @param wow64  0 for standard registry access (32-bits for 32-bit app, 64-bits for 64-bits app)
   *               or KEY_WOW64_32KEY to force access to 32-bit registry view,
   *               or KEY_WOW64_64KEY to force access to 64-bit registry view
   * @throws IllegalArgumentException
