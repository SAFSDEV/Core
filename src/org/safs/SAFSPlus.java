...
public abstract class SAFSPlus {
	...
	/**
	 * To get the SAFSPlus work correctly for the sub-class (Ex. SeleniumPlus), 
	...
	/**
	 * Wrapper class to handle <a href="http://safsdev.github.io/sqabasic2000/DDDriverCommandsIndex.htm">Driver keywords</a>, like StartWebBrowser, UseWebBrowser, SetPosition etc.<br>
	 */
	public static class DriverCommand{
		 ...
		 * @param params optional, currently <b>ONLY supported for Selenium WebDriver Engine.</b>
		 * <p>
		 * <ul>
		 ...
		 * For the detail explanation of starting browser with "custom profile" and/or "preferences", please visit the section "<font color="red">Start Browser</font>" at <a href="http://safsdev.github.io/selenium/doc/SeleniumPlus-Welcome.html">Selenium Welcome Document</a>. 
		 * </b>
		 * 
	...
	/**
	 * Wrapper class to handle <a href="http://safsdev.github.io/sqabasic2000/DDDriverCounterCommandsIndex.htm">DriverCounter keywords</a>, like StartTestSuite, StartCounter, LogCounterInfo etc.<br>
	 * It also provides:<br>
		...
		try{ 
			...
			if(_autorun){
				...
				if(_junit.length() == 0){
					...
					try{
						debug("SeleniumPlus JUnit '"+ _junit +"' will now execute.");
