 ...
 *
 *   msxsl.exe JavaTableFunctions.xml XSLJavaCommandModel.xsl -o JavaTableFunctions.java
 *
 ******************************************************************************/ 
...
public class JavaTableFunctions {

    /*****************
    Private Singleton Instance
    ****************/
    private static final JavaTableFunctions singleton = new JavaTableFunctions(); 

    /*****************
    Private Constructor
    Static class needing no instantiation.
    ****************/
    private JavaTableFunctions() {}

    /*****************
    public Singleton to access class static methods via instance
    ****************/
    public static JavaTableFunctions getInstance() { return singleton;}
    ...
    static public final String RIGHTCLICKCOLUMNLABEL_KEYWORD = "RightClickColumnLabel";
    /** "SelectCell" */
...
<BR/>        row -- Optional:YES  DefaultVal:1 
     ...
     **********/
    static public ComponentFunction rightClickColumnLabel (String winname, String compname, String colNumber, String yOffset) {

        if ( winname == null ) throw new IllegalArgumentException ( "rightClickColumnLabel.winname = null");
        if ( compname == null ) throw new IllegalArgumentException ( "rightClickColumnLabel.compname = null");

        if ( colNumber == null ) throw new IllegalArgumentException ( "rightClickColumnLabel.colNumber = null");
        ComponentFunction cf = new ComponentFunction(RIGHTCLICKCOLUMNLABEL_KEYWORD, winname, compname);
        cf.addParameter(colNumber);
        cf.addParameter(yOffset);
        return cf;
    }
...
<BR/>        colNumber -- Optional:NO
     ...
     **********/
    static public ComponentFunction rightClickColumnLabel(String winname, String compname, String[] parameters) {
