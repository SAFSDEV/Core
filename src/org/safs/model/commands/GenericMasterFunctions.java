...
<BR/>        propertyName -- Optional:NO
     ...
     **********/
    static public ComponentFunction verifyBinaryFileToFile (String winname, String compname, String benchmarkFile, String actualFile, String filterMode, String filterOptions, String alterImageStyle, String alterImageFactor, String pdfResolution) {
        ...
        cf.addParameter(filterMode);
        cf.addParameter(filterOptions);
        cf.addParameter(alterImageStyle);
        cf.addParameter(alterImageFactor);
        cf.addParameter(pdfResolution);
        return cf;
    }
