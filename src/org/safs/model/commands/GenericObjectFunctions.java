...
public class GenericObjectFunctions {
    ...
    ****************/
    ...
    /** "AltClick" */
    static public final String ALTCLICK_KEYWORD = "AltClick";
    /** "AltLeftDrag" */
    ...
    /*********** <pre>
                ...
                We can also ALT-click on any part of an object based on a stored x,y
                coordinate.  The object containing the coordinate is first given
                context and then a ALT-click is generated at the coordinate.  Thus, an item
                ...
                of the Application Map to ALT-click at x=3, y=10 in the MainWindow. For SE+, the 
                ...
                object and ALT-click at the coordinates specified by the reference.
     ...
     **********/
    static public ComponentFunction altClick (String winname, String compname, String appMapSubkey, String autoScroll) {

        if ( winname == null ) throw new IllegalArgumentException ( "altClick.winname = null");
        if ( compname == null ) throw new IllegalArgumentException ( "altClick.compname = null");

        ComponentFunction cf = new ComponentFunction(ALTCLICK_KEYWORD, winname, compname);
...
<BR/>        appMapSubkey -- Optional:YES
     ...
     **********/
    static public ComponentFunction altClick(String winname, String compname, String[] parameters) {

        if ( winname == null ) throw new IllegalArgumentException ( "altClick.winname = null");
        if ( compname == null ) throw new IllegalArgumentException ( "altClick.compname = null");
        if ( parameters == null ) throw new IllegalArgumentException ( "altClick.parameters = null");
        ComponentFunction cf = new ComponentFunction(ALTCLICK_KEYWORD, winname, compname);
