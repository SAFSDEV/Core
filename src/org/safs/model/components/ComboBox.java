...
<BR/>         fileName -- Optional:NO 
    ...
    public ComponentFunction select(String textValue ) {
        ...
        return ComboBoxFunctions.select(getWindow().getName(), getName(), textValue);
    }
    ...
    public void select(StepTestTable table, String textValue ) {
        ...
        if ( textValue == null ) throw new IllegalArgumentException ( "select.textValue = null");
        table.add( ComboBoxFunctions.select(getWindow().getName(), getName(), textValue));
    }
    ...
    public ComponentFunction selectIndex(String indexValue ) {
        ...
        return ComboBoxFunctions.selectIndex(getWindow().getName(), getName(), indexValue);
    }
    ...
    public void selectIndex(StepTestTable table, String indexValue ) {
        ...
        if ( indexValue == null ) throw new IllegalArgumentException ( "selectIndex.indexValue = null");
        table.add( ComboBoxFunctions.selectIndex(getWindow().getName(), getName(), indexValue));
    }
    ...
    public ComponentFunction selectPartialMatch(String textValue ) {
        ...
        return ComboBoxFunctions.selectPartialMatch(getWindow().getName(), getName(), textValue);
    }
    ...
    public void selectPartialMatch(StepTestTable table, String textValue ) {
        ...
        if ( textValue == null ) throw new IllegalArgumentException ( "selectPartialMatch.textValue = null");
        table.add( ComboBoxFunctions.selectPartialMatch(getWindow().getName(), getName(), textValue));
    }
     ...
     **********/
    public ComponentFunction selectUnverified(String textValue ) {

        if ( textValue == null ) throw new IllegalArgumentException ( "selectUnverified.textValue = null");
        return ComboBoxFunctions.selectUnverified(getWindow().getName(), getName(), textValue);
    }
     ...
     **********/
    public void selectUnverified(StepTestTable table, String textValue ) {

        if ( table == null ) throw new IllegalArgumentException ( "selectUnverified.table = null");

        if ( textValue == null ) throw new IllegalArgumentException ( "selectUnverified.textValue = null");
        table.add( ComboBoxFunctions.selectUnverified(getWindow().getName(), getName(), textValue));
    }
