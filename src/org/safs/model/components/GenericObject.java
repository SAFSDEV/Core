...
public class GenericObject extends GenericMaster {
    ...
    ****************/
     ...
     **********/
    public ComponentFunction altClick(String appMapSubkey, String autoScroll ) {

        return GenericObjectFunctions.altClick(getWindow().getName(), getName(), appMapSubkey, autoScroll);
    }
     ...
     **********/
    public void altClick(StepTestTable table, String appMapSubkey, String autoScroll ) {

        if ( table == null ) throw new IllegalArgumentException ( "altClick.table = null");

        table.add( GenericObjectFunctions.altClick(getWindow().getName(), getName(), appMapSubkey, autoScroll));
    }
...
<BR/>         appMapSubkey -- Optional:YES
     ...
     **********/
    public ComponentFunction altClick(String[] parameters ) {

        if ( parameters == null ) throw new IllegalArgumentException ( "altClick.parameters = null");
        return GenericObjectFunctions.altClick(getWindow().getName(), getName(), parameters);
    }
...
<BR/>         appMapSubkey -- Optional:YES
     ...
     **********/
    public void altClick(StepTestTable table, String[] parameters ) {

        if ( table == null ) throw new IllegalArgumentException ( "altClick.table = null");
        if ( parameters == null ) throw new IllegalArgumentException ( "altClick.parameters = null");
        table.add( GenericObjectFunctions.altClick(getWindow().getName(), getName(), parameters));
    }
...
<BR/>         appMapSubkey -- Optional:YES 
     ...
     **********/
    public ComponentFunction dragTo(String toWindow, String toComponent, String offsets, String fromSubItem, String toSubItem, String pause ) {
        ...
        return GenericObjectFunctions.dragTo(getWindow().getName(), getName(), toWindow, toComponent, offsets, fromSubItem, toSubItem, pause);
    }
    ...
    <LI>OpenQA Selenium</LI>
     ...
     @param pause  Optional:YESPause time in millisecond to hold the button before releasing.
     **********/
    public void dragTo(StepTestTable table, String toWindow, String toComponent, String offsets, String fromSubItem, String toSubItem, String pause ) {

        if ( table == null ) throw new IllegalArgumentException ( "dragTo.table = null");

        if ( toComponent == null ) throw new IllegalArgumentException ( "dragTo.toComponent = null");
        if ( toWindow == null ) throw new IllegalArgumentException ( "dragTo.toWindow = null");
        table.add( GenericObjectFunctions.dragTo(getWindow().getName(), getName(), toWindow, toComponent, offsets, fromSubItem, toSubItem, pause));
    }
