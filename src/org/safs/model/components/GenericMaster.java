...
<BR/>         propertyName -- Optional:NO
    ...
    /*********** <pre> 
             ...
             If the files are image, a diff image will be created if there are considered different.
             If the files are PDF, they will be converted to image files and then compared as image file. Each PDF page
             will be converted to an image, so comparison of 2 PDF files might be comparison of 2 set of image files.
    ...
    <LI>Automated QA TestComplete</LI>
     ...
     @param alterImageStyle  Optional:YES  DefaultVal: 
                It is used to alter the diff image when 2 image/PDF doesn't match.
              
     @param alterImageFactor  Optional:YES  DefaultVal: 
                How much lighter or darker to alter the original pixel (with no difference), it is a double number between 0 and 1.
              
     @param pdfResolution  Optional:YES  DefaultVal: 
                The resolution (DPI) used to convert PDF to image.
              
     **********/
    public ComponentFunction verifyBinaryFileToFile(String benchmarkFile, String actualFile, String filterMode, String filterOptions, String alterImageStyle, String alterImageFactor, String pdfResolution ) {
        ...
        return GenericMasterFunctions.verifyBinaryFileToFile(getWindow().getName(), getName(), benchmarkFile, actualFile, filterMode, filterOptions, alterImageStyle, alterImageFactor, pdfResolution);
    }
     ...
     **********/
    public void verifyBinaryFileToFile(StepTestTable table, String benchmarkFile, String actualFile, String filterMode, String filterOptions, String alterImageStyle, String alterImageFactor, String pdfResolution ) {

        if ( table == null ) throw new IllegalArgumentException ( "verifyBinaryFileToFile.table = null");

        if ( actualFile == null ) throw new IllegalArgumentException ( "verifyBinaryFileToFile.actualFile = null");
        if ( benchmarkFile == null ) throw new IllegalArgumentException ( "verifyBinaryFileToFile.benchmarkFile = null");
        table.add( GenericMasterFunctions.verifyBinaryFileToFile(getWindow().getName(), getName(), benchmarkFile, actualFile, filterMode, filterOptions, alterImageStyle, alterImageFactor, pdfResolution));
    }
...
<BR/>         benchmarkFile -- Optional:NO 
             ...
             File used as the comparison file under test.
              ...
              <BR/>         filterOptions -- Optional:YES  DefaultVal: 
                Specify filter options to use with the filter.
              <BR/>         alterImageStyle -- Optional:YES  DefaultVal: 
                It is used to alter the diff image when 2 image/PDF doesn't match.
              <BR/>         alterImageFactor -- Optional:YES  DefaultVal: 
                How much lighter or darker to alter the original pixel (with no difference), it is a double number between 0 and 1.
              <BR/>         pdfResolution -- Optional:YES  DefaultVal: 
                The resolution (DPI) used to convert PDF to image.
