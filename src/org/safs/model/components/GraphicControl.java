 ...
 *
 *   msxsl.exe GraphicControlFunctions.xml XSLJavaComponentModel.xsl -o GraphicControl.java
 *
 ******************************************************************************/ 
package org.safs.model.components;

import org.safs.model.commands.GraphicControlFunctions;
import org.safs.model.ComponentFunction;
import org.safs.model.components.UIComponent;
import org.safs.model.StepTestTable;

public class GraphicControl extends GenericObject {
    ...
    ****************/
    public GraphicControl(Window window, String compname) {
    ...
    @param compname Optional:NO 
           Specifies the AppMap name of the component in the Window.
    ****************/
    public GraphicControl(String winname, String compname) {

        this(new Window(winname), compname);
    }

    protected GraphicControl(String compname) {
    ...
    public ComponentFunction click( ) {
        ...
        return GraphicControlFunctions.click(getWindow().getName(), getName());
    }
    ...
    public void click(StepTestTable table ) {
        ...
        table.add( GraphicControlFunctions.click(getWindow().getName(), getName()));
    }
    ...
    public ComponentFunction clickButton( ) {
        ...
        return GraphicControlFunctions.clickButton(getWindow().getName(), getName());
    }
    ...
    public void clickButton(StepTestTable table ) {
        ...
        table.add( GraphicControlFunctions.clickButton(getWindow().getName(), getName()));
    }
