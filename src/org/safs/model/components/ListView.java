...
<BR/>         selectTextValue -- Optional:NO 
     ...
     **********/
    public ComponentFunction assignCellValue(String variable, String rowCoord, String colCoord ) {
        ...
        return ListViewFunctions.assignCellValue(getWindow().getName(), getName(), variable, rowCoord, colCoord);
    }
     ...
     **********/
    public void assignCellValue(StepTestTable table, String variable, String rowCoord, String colCoord ) {
        ...
        if ( rowCoord == null ) throw new IllegalArgumentException ( "assignCellValue.rowCoord = null");
        if ( variable == null ) throw new IllegalArgumentException ( "assignCellValue.variable = null");
        table.add( ListViewFunctions.assignCellValue(getWindow().getName(), getName(), variable, rowCoord, colCoord));
    }
