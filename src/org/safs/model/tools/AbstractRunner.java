 ...
 *
 * History:
 * NOV 02, 2016    (Lei Wang) Most codes were moved from org.safs.model.tools.EmbeddedHookDriverRunner
 * SEP 25, 2018    (Lei Wang) Mark the method action() command() with annotation @TestStep.
 */
...
import org.safs.model.annotations.TestStep;
...
public abstract class AbstractRunner implements JSAFSConfiguredClassStore{
	...
	public void autorun(String[] args) throws Throwable{
		...
		//Lei Wang, get the caller's classname, replace deprecated sun.reflect.Reflection.getCallerClass()
		if(!found){
			try{
...
//		//Lei Wang comment it out for the TODO task
